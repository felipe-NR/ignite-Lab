...
export function Video(props:Video.Props) {
    console.log(props.lessonSlug)
    const { data } = useQuery<Video.GetLessonBySlugResponse>(GET_LESSON_BY_SLUG_QUERY, {
        variables: { slug: props.lessonSlug }, fetchPolicy: 'no-cache'
    })
